    ...
    <div className="w-full bg-base-surface min-h-screen py-12">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-base-muted mt-2 text-sm">Manage your personal information and account details.</p>
        </div>
          ...
          <div className="bg-white p-8">
            <div className="flex flex-col items-center mb-8 pb-8 border-b border-base-border">
              <div className="w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-slate-50 shadow-sm">
                <img 
                  src={profile.image || "https://res.cloudinary.com/dqc2xhnac/image/upload/v1708583159/Med-equip/p3sq9ishi7myfxij6wxy.png"} 
                  alt="Profile" 
            ...
            <div className="space-y-6 max-w-lg mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="text" value={profile.name || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="text" value={profile.email || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="text" value={profile.phone_number || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="text" value={profile.age || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                </div>
                ...
                {role == "3" && (
                  <>
                    <div className="space-y-1.5">
                      ...
                      <Input type="text" value={profile.qualification || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-semibold text-base-muted uppercase tracking-wider flex items-center gap-1.5">
                        <User size={14} /> Status
                      </label>
                      <Input type="text" value={profile.status || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                    </div>
                  </>
                )}
                ...
                {role == "2" && profile.user_id && (
                  <div className="space-y-1.5">
                    ...
                    <Input type="text" value={profile.user_id || ""} disabled className="bg-slate-50 border-transparent text-slate-700" />
                  </div>
                )}
              </div>
