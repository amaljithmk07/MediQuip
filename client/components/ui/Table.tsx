...
const TableFooter = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('border-t bg-base-surface font-medium [&>tr]:last:border-b-0', className)}
    {...props}
  />
));
...
const TableRow = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-base-border transition-colors hover:bg-base-surface/50 data-[state=selected]:bg-base-surface',
      className
    )}
    {...props}
  />
...
const TableHead = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-medium text-base-muted [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
const TableCaption = React.forwardRef<any, any>(({ className, ...props }, ref) => (
  <caption ref={ref} className={cn('mt-4 text-sm text-base-muted', className)} {...props} />
));
