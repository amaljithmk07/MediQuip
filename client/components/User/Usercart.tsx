...
import { cartView, cartdelete, decrementqty, incrementqty } from '../../redux/reducer/CartSlice';
        ...
        {isEmpty ? (
          <div className="bg-white rounded-3xl shadow-soft border border-slate-100 p-16 flex flex-col items-center justify-center text-center animate-fade-in-up">
            ...
            <p className="text-slate-500 mb-8 max-w-md">
              Looks like you haven't added any medical equipment to your cart yet. Browse our
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-100">
                      <th className="py-4 px-6 font-semibold text-slate-600 text-sm uppercase tracking-wider">
                        Product
                      </th>
                      <th className="py-4 px-6 font-semibold text-slate-600 text-sm uppercase tracking-wider text-center">
                        Status
                      </th>
                      <th className="py-4 px-6 font-semibold text-slate-600 text-sm uppercase tracking-wider text-center">
                        Quantity
                      </th>
                      <th className="py-4 px-6 font-semibold text-slate-600 text-sm uppercase tracking-wider text-right">
                        Action
                      </th>
                    </tr>
                  </thead>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-slate-500 mt-1">
                                {item.category} &bull; {item.sub_category}
                              </div>
                            </div>
                          </div>
                        </td>
