            ...
            <div className="bg-white rounded-3xl shadow-soft border border-slate-100 p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex justify-between items-center mb-6">
                ...
                <Link
                  ...
                  href="/user/address"
                  className="text-sm font-bold text-teal-600 hover:text-teal-700 transition-colors bg-teal-50 px-4 py-2 rounded-xl"
                >
                  Edit
                </Link>
              </div>
              ...
              <div className="border-t border-slate-100 pt-6 mb-8">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="relative flex items-center justify-center mt-1">
                    ...
                    />
                    <div
                      className={`w-5 h-5 rounded border ${agreed ? 'bg-teal-600 border-teal-600' : 'bg-white border-slate-300'} transition-colors flex items-center justify-center`}
                    >
                      {agreed && (
                        <svg
